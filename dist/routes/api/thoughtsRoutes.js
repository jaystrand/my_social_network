...
const router = Router();
import { getAllThoughts, getThoughtsById, createThoughts, updateThoughts, deleteThoughts, addReactions, removeReactions, } from '../../controllers/thoughtsController.js';
// /api/thoughts
